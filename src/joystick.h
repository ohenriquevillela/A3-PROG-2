...
typedef struct {																													//Definição da estrutura de um controle (!)
	...
	unsigned char down;	
	unsigned char right2;																											//Botão de movimentação à direta (!)
	unsigned char left2;																											//Botão de movimentação à esquerda (!)
	unsigned char up2;																												//Botão de movimentação para cima (!)
	unsigned char down2;																											//Botão de movimentação para baixo (!)
...
void joystick_right2(joystick *element);																							//Protótipo da função de ativação/desativação do botão de movimentação à direita (!)
void joystick_left2(joystick *element);																								//Protótipo da função de ativação/desativação do botão de movimentação à esquerda (!)
void joystick_up2(joystick *element);																								//Protótipo da função de ativação/desativação do botão de movimentação para cima (!)
void joystick_down2(joystick *element);																								//Protótipo da função de ativação/desativação do botão de movimentação para baixo (!)
#endif